...
$query = "SELECT * FROM voterinformation";
    ...
    <div ng-app="myApp" ng-controller="myCtrl">
        ...
        <table class="table table-hover">
            ...
            <tr>
                  ...
                  <td><input type="text" ng-model="search.house_no_reg_language" placeholder="Search House No."></td>
                ...
                <tr>
                  ...
                  <th>House Number in reg_language</th>
                  <th>Serial Number</th>
                  <th>Assembly</th>
