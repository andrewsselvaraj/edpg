                        ...
                        <div style="overflow-x:auto;">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <select ng-model="search.Election" ng-options="option for option in elections"
                                        placeholder="Search Election" class="form-control">
                                        <option value="">Select Election</option>

                                    </select>
                                </div>
                                <div class="col-4">
                                    <input type="text" ng-model="search.state_name" placeholder="Search State"
                                        class="form-control" />
                                    <select ng-model="search.state_name" ng-options="option for option in state_names"
                                        placeholder="Search State" class="form-control">
                                ...
                                <div class="col-4">
                                    ...
                                    <select ng-model="search.MP_Constituency"
                                        ng-options="option for option in mp_constituencies"
                                        placeholder="Search MP Constituency" class="form-control">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <select ng-model="search.Constituency"
                                        ng-options="option for option in constituencies"
                                        placeholder="Search Constituency" class="form-control">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="number" ng-model="search.Polling_Station_No"
                                        placeholder="Search Polling Station No." class="form-control"></br></br>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" ng-model="search.Polling_areas"
                                        placeholder="Search Polling areas" class="form-control"></br></br>

                                </div>
                            </div>
                            <div class="row">
                                <div class="col-4">
                                    <input type="text" ng-model="search.Candidate_Name" placeholder="Search Candidate
                                    Name" class="form-control"></br></br>
                                    <select ng-model="search.Candidate_Name"
                                        ng-options="option for option in candidate_names"
                                        placeholder="Search Candidate Names" class="form-control">
                                ...
                                <div class="col-4">
                                    ...
                                    <select ng-model="search.Party_Name" ng-options="option for option in party_names"
                                        placeholder="Search Party Names" class="form-control">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="number" ng-model="search.No_of_Votes" placeholder="Search No. of Votes"
